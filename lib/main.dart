...
const markets = <Market>[
  ...
  Market('EUR/CHF', 'EUR/CHF', 'Cross'),
  Market('EUR/AUD', 'EUR/AUD', 'Cross'),
  Market('EUR/CAD', 'EUR/CAD', 'Cross'),
  Market('EUR/NZD', 'EUR/NZD', 'Cross'),
  Market('GBP/JPY', 'GBP/JPY', 'Cross'),
  Market('GBP/CHF', 'GBP/CHF', 'Cross'),
  Market('GBP/AUD', 'GBP/AUD', 'Cross'),
  Market('GBP/CAD', 'GBP/CAD', 'Cross'),
  Market('GBP/NZD', 'GBP/NZD', 'Cross'),
  Market('AUD/JPY', 'AUD/JPY', 'Cross'),
  Market('AUD/CHF', 'AUD/CHF', 'Cross'),
  Market('AUD/CAD', 'AUD/CAD', 'Cross'),
  Market('AUD/NZD', 'AUD/NZD', 'Cross'),
  Market('CAD/JPY', 'CAD/JPY', 'Cross'),
  Market('CAD/CHF', 'CAD/CHF', 'Cross'),
  Market('CHF/JPY', 'CHF/JPY', 'Cross'),
  Market('NZD/JPY', 'NZD/JPY', 'Cross'),
  Market('NZD/CHF', 'NZD/CHF', 'Cross'),
  Market('NZD/CAD', 'NZD/CAD', 'Cross'),
